...
// API may return nodes as an object keyed by node type name OR as an array
// This type supports both formats for flexibility
export type NodeTypesResponse = NodeType[] | { [nodeTypeName: string]: NodeType };
