...
export const getKnowledgeStorageToolDef: Tool = {
  name: 'get_knowledge_storage',
  description:
    'Get storage usage information for your knowledge base, including total space used, limits, and document counts.',
  inputSchema: {
    type: 'object',
    properties: {},
    required: [],
...
export async function handleGetKnowledgeStorage(
