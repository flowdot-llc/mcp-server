...
export const listUserTeamsToolDef: Tool = {
  name: 'list_user_teams',
  description:
    'List all teams you belong to. Use this to discover available teams before filtering knowledge base operations by team. Returns team ID, name, your role, and member count.',
  inputSchema: {
    type: 'object',
    properties: {},
    required: [],
...
export async function handleListUserTeams(
