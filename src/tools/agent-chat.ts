...
export const agentChatTool: Tool = {
  name: 'agent_chat',
  description:
    'Chat with the FlowDot AI agent. The agent can help discover workflows, suggest which workflow to run, and explain workflow capabilities.',
  inputSchema: {
    type: 'object',
    properties: {
      message: {
...
export async function handleAgentChat(
  ...
  args: { message: string; conversation_id?: string; mode?: string }
