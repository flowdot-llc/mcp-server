 ...
 */
export const getNodeConnectionsTool = {
...
export async function handleGetNodeConnections(api, args) {
    try {
        // API returns { node_id, incoming: [...], outgoing: [...], total: N }
        const result = await api.getNodeConnections(args.workflow_id, args.node_id);
...
//# sourceMappingURL=get-node-connections.js.map