...
export const updateCustomNodeTool = {
...
export async function handleUpdateCustomNode(api, args) {
    try {
        ...
        const filteredUpdates = Object.fromEntries(Object.entries(finalUpdates).filter(([_, v]) => v !== undefined));
...
//# sourceMappingURL=update-custom-node.js.map