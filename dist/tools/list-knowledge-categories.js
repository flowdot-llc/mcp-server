...
export const listKnowledgeCategoriesToolDef = {
    ...
    description: 'List all document categories in your knowledge base. Categories help organize documents for easier retrieval and targeted RAG queries.',
    inputSchema: {
        type: 'object',
        properties: {},
        required: [],
...
export async function handleListKnowledgeCategories(api) {
    try {
