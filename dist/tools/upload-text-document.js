...
export const uploadTextDocumentToolDef = {
    ...
    description: 'Upload text content directly as a document to your knowledge base. Ideal for creating documents from AI-generated content, notes, or any text. The document will be processed and chunked for RAG queries.',
    inputSchema: {
        type: 'object',
        properties: {
            title: {
